      ...
      <div class="row">
        <div class="col-md-12">
          <div style="margin-top: 15px;">
            <el-input placeholder="请输入帖子关键字" v-model="input5" class="input-with-select">
              <el-button slot="append" icon="el-icon-search"></el-button>
            </el-input>
          </div>
          <waterfall :line-gap="500" :watch="arrayData" style="margin-top: 10px">
            ...
            >
              <el-card :body-style="{ padding: '10px' }">
                ...
                <div style="padding: 14px;">
                  <div style="color: rgba(0,172,214,0.93);font-size: 16px">{{item.text}}</div>
...
<script>
  ...
  export default {
    ...
    created () {
      api.request('get', 'status/timeline?userid=1&page=0&count=20&type=1')
        .then(response => {
          this.arrayData = response.data.body.data.posts
